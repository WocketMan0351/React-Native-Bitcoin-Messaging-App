        ...
        <>
          <View style={styles.iconRow}>
            <MaterialIcons
              ...
              color='#006ee6'
              onPress={() =>
                openUrl('https://bitcoin.clarkmoody.com/dashboard/')
              }
            />
          </View>
          <View style={styles.iconText}>
            <Text style={{ color: '#006ee6' }}>Clark Moody Dashboard</Text>
          </View>
          <View>
            <Image
          ...
          <View style={styles.container}>
            ...
            <View style={styles.row}>
              ...
              <Text style={[styles.colLeft, { color: colors.text }]}>
                {/* {'$ ' +
                  `${data.bitcoin.usd_market_cap}`.substring(0, 4) +
                  '.' +
                  `${data.bitcoin.usd_market_cap}`.substring(3, 5) +
                  ' B'} */}
                {'$ ' +
                  (
                    parseFloat(data.bitcoin.usd_market_cap) / Math.pow(10, 12)
                  ).toFixed(3) +
                  ' T'}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              ...
              <Text style={[styles.colLeft, { color: colors.text }]}>
                {Number(`${hashRate}` / Math.pow(1000, 3)).toFixed(2) +
                  'M' +
                  ' TH/s'}
              </Text>
            </View>
